      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-start gap-8 pb-9 border-b border-white/[0.07] mb-6">
          ...
          <div className="max-w-xs">
            ...
            <p className="text-white/45 text-sm leading-relaxed">
              Mitra strategis payment, teknologi &amp; merchandising terpercaya
              untuk bisnis Anda.
            </p>
          </div>
          ...
          <div className="flex gap-16">
            <div>
              <div className="text-[11px] font-semibold tracking-[0.1em] uppercase text-white/30 mb-3">
                Navigasi
              </div>
              <ul className="flex flex-col gap-2.5 list-none">
                {[
                  ...
                  <li key={item.href}>
                    <a
                      href={item.href}
                      className="text-white/55 hover:text-[#F5A623] text-sm no-underline transition-colors"
                    >
                      {item.label}
                    </a>
                  </li>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-3">
          <p className="text-white/30 text-xs">
            © 2025{" "}
            <span className="text-[#F5A623]">CV Bangda Bertiga Karya</span>. All
            rights reserved.
          </p>
